...
class AdicionaValores extends StatefulWidget {
  final Movimentacoes mov;
  const AdicionaValores({Key key, this.mov}) : super(key: key);

  @override
  _AdicionaValoresState createState() => _AdicionaValoresState();
}

class _AdicionaValoresState extends State<AdicionaValores> {
