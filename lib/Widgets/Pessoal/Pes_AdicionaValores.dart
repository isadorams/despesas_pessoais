...
class AdicionaValoresPessoal extends StatefulWidget {
  final MovimentacoesP mov;
  const AdicionaValoresPessoal({Key key, this.mov}) : super(key: key);

  @override
  _AdicionaValoresPessoalState createState() => _AdicionaValoresPessoalState();
}

class _AdicionaValoresPessoalState extends State<AdicionaValoresPessoal> {
  ...
  MovimentacoesPessoal _movHelper = MovimentacoesPessoal();
