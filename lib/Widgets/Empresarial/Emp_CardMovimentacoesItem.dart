...
class CardMovimentacoesItemEmpresarial extends StatelessWidget {
  final MovimentacoesE mov;
  final bool lastItem;

  const CardMovimentacoesItemEmpresarial(
      {Key key, this.mov, this.lastItem = false})
      : super(key: key);
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            MovimentacoesEmpresarial movHelper =
  ...
  _dialogEdit(BuildContext context, double width, MovimentacoesE movimentacao) {
